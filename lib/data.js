...
// This now reads the live JSON file.
export function getUserData() {
  try {
    ...
    // Return a default structure ONLY if the file is missing/corrupt.
    return {
...
// These functions will now return live data from the JSON file.
