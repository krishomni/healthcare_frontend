    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="pt-32 pb-16 text-center">
          <h1 className="text-3xl font-bold text-gray-900">No Services Available</h1>
          <p className="text-gray-600 mt-4">Please add services through the admin panel.</p>
          <Link href="/admin/login" className="mt-6 inline-block bg-blue-600 text-white px-6 py-3 rounded-lg">
            Go to Admin
          </Link>
        </div>
      </div>
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Comprehensive healthcare services" />
      </Head>
              ...
              {userData.services.map((service, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Link
                      href="/contact"
                      className="mt-6 block text-center bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors"
                    >
                      Book Appointment
                    </Link>
                  </motion.div>
